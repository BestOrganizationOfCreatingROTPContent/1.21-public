...
clothes_example.jar:
    ...
    - data: Data pack files - they register the clothes sets in the mod, and optinally you can also register a new JoJo character that will be associated with specific clothes set(s).
    ...
    Also, "jojo_ripples" is the main mod's namespace, so you might want to rename the directories with this name to something else of your choice.
...
public final class ModDataAttachmentTypes {
	...
	@ApiStatus.Internal
	public static final Supplier<AttachmentType<LivingAction>> LIVING_ACTION = ATTACHMENT_TYPES.register("living_action", 
			() -> AttachmentType.serializable(LivingAction::create).build());

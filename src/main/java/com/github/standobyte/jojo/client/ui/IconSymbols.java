...
public class IconSymbols {
	...
	public static final char LMB_CLICK = IconGlyphsCache.getOrComputeCharCode(new IconGlyphInfo(
			new GuiIcon(JojoMod.resLoc("textures/gui/sprites/left_click.png"), 3, 0, 9, 16, 16, 16), 4.5f, 8));
	public static final char RMB_CLICK = IconGlyphsCache.getOrComputeCharCode(new IconGlyphInfo(
			new GuiIcon(JojoMod.resLoc("textures/gui/sprites/right_click.png"), 3, 0, 9, 16, 16, 16), 4.5f, 8));
	public static final char MMB_CLICK = IconGlyphsCache.getOrComputeCharCode(new IconGlyphInfo(
